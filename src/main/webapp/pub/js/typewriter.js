...
(function() { (function() {
        for (var a = 0,
        c = ["ms", "moz", "webkit", "o"], b = 0; b < c.length && !window.requestAnimationFrame; ++b) window.requestAnimationFrame = window[c[b] + "RequestAnimationFrame"],
    ...
    window.Typewriter = function(a, c) {
        ...
        if ("object" !== typeof c) return console.error("Typewriter only accepts the options as an object.");
        ...
        this._startCursorAnimation(); ! 0 === this.options.autoStart && this.options.strings && this.typeOutAllStrings()
    };
    ...
    b.typeOutAllStrings = function() {
        ...
        b = a.length; c < b; c++) this._addToEventQue([this._typeCharacters, [a[c]]]),
    ...
    b.changeSettings = function(a) {
        if (!a && "object" !== typeof a) return console.error("Typewriter will only accept an object as the settings.");
    ...
    b._deletingCharAnimationFrame = function() {
        ...
        if (!a._settings.charAmountToDelete || 0 === a._settings.charAmountToDelete || 0 === d) return a._resetEventLoop("deletingCharAnimationFrame"),
        !0;
        ...
        setTimeout(function() {
            if (a._settings.charAmountToDelete) {
                ...
                if (c = document.getElementById(f)) a.el.querySelector("." + b).removeChild(c),
    ...
    b._setupOptions = function(a) {
        ...
        if (this._settings.userOptions) for (b in this._settings.userOptions) c[b] = this._settings.userOptions[b];
        for (b in a) c[b] = a[b];
        return c
    };
    ...
    b._typingAnimationFrame = function(a) {
        ...
        if (0 == c._settings.stringToTypeHTMLArray.length) return window.cancelAnimationFrame(c._typingAnimation),
    ...
    b._randomID = function() {
        for (var a = "",
        b = 0; b < this._randomInteger(5, 15); b++) a += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".charAt(Math.floor(62 * Math.random()));
        return a
    };
